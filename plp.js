...
const PLP_CATALOG = (() => {
  ...
  // Solo productos con imágenes disponibles
  const categories = [
    // Manzanas (4)
    { name: 'Manzana Red Delicious Importada Suprema', img: 'assets/product-manzana-red.png', base: 45 },
    { name: 'Manzana Verde Granny Smith', img: 'assets/product-manzana-verde.png', base: 38 },
    { name: 'Manzana Gala Nacional', img: 'assets/product-manzana-3.png', base: 35 },
    { name: 'Bolsa Manzanas Mixtas 1 kg', img: 'assets/product-manzana-4.png', base: 46 },

    // Cítricos (4)
    { name: 'Naranja Valencia Orgánica', img: 'assets/naranja.webp', base: 32 },
    { name: 'Limón Persa Fresco', img: 'assets/Limon.webp', base: 28 },
    { name: 'Toronja Rosa Importada', img: 'assets/toronja.webp', base: 42 },
    { name: 'Mandarina Clemenita Dulce', img: 'assets/mandarina.webp', base: 35 },

    // Frutas Tropicales (4)
    { name: 'Piña Miel Seleccionada', img: 'assets/512260_01.webp', base: 35 },
    { name: 'Mango Ataulfo Fresco', img: 'assets/mango.webp', base: 30 },
    { name: 'Papaya Maradol Premium', img: 'assets/301918_01.webp', base: 20 },
    { name: 'Plátano Tabasco Manojo', img: 'assets/platano.webp', base: 22 },

    // Berries (4)
    { name: 'Fresas Frescas 454 g', img: 'assets/fresas.webp', base: 79 },
    { name: 'Moras Silvestres 250 g', img: 'assets/mora.webp', base: 65 },
    { name: 'Blueberries Orgánicos 125 g', img: 'assets/blueberry.webp', base: 72 },
    { name: 'Frambuesas Frescas 125 g', img: 'assets/frambuesa.webp', base: 68 },

    // Frutas de Hueso (2)
    { name: 'Durazno Fresco Importado', img: 'assets/durazno.webp', base: 38 },
    { name: 'Nectarina Premium', img: 'assets/nectarina.webp', base: 42 },

    // Frutas Exóticas (5)
    { name: 'Aguacate Supremo Hass', img: 'assets/aguacate.webp', base: 93 },
    { name: 'Coco Fresco Entero', img: 'assets/301841_01.webp', base: 30 },
    { name: 'Kiwi Zespri SunGold', img: 'assets/323977_01.webp', base: 15 },
    { name: 'Uva Roja Suprema sin Semilla', img: 'assets/uva-roja.webp', base: 135 },
    { name: 'Pitahaya Rosa Fresca', img: 'assets/427906_01.webp', base: 38 },

    // Nuevos productos (7 más)
    { name: 'Naranja Navel Importada', img: 'assets/naranja.webp', base: 38 },
    { name: 'Limón Tahití Premium', img: 'assets/Limon.webp', base: 32 },
    { name: 'Toronja Blanca Dulce', img: 'assets/toronja.webp', base: 45 },
    { name: 'Mango Ataúlfo Orgánico', img: 'assets/mango.webp', base: 35 },
    { name: 'Papaya Hawaiana Premium', img: 'assets/301918_01.webp', base: 25 },
    { name: 'Plátano Macho Orgánico', img: 'assets/platano.webp', base: 28 },
    { name: 'Ciruela Roja Importada', img: 'assets/mora.webp', base: 42 },
  ];

  // Generar 300 productos con variaciones de nombres para evitar deduplicación
  const suffixes = ['', 'Premium', 'Orgánica', 'Importada', 'Fresca', 'Seleccionada', 'Extra', 'Suprema'];
  let productIdx = 1;
  for (let i = 0; i < 300; i++) {
    const category = categories[i % categories.length];
    const suffix = suffixes[(Math.floor(i / 30)) % suffixes.length];
...
const SIMILAR_PRODUCTS = [
  ...
  { id: 's5', name: 'Kiwi Zespri SunGold', price: '$19.00', priceOld: '$23.00', img: 'assets/323977_01.webp' },
  { id: 's6', name: 'Naranja Valencia Orgánica', price: '$32.00', priceOld: '$38.00', img: 'assets/naranja.webp' },
  { id: 's7', name: 'Limón Persa Fresco', price: '$28.00', priceOld: '$34.00', img: 'assets/Limon.webp' },
  { id: 's8', name: 'Toronja Rosa Importada', price: '$42.00', priceOld: '$50.00', img: 'assets/toronja.webp' },
  { id: 's9', name: 'Papaya Maradol Premium', price: '$20.00', priceOld: '$26.00', img: 'assets/301918_01.webp' },
  { id: 's10', name: 'Fresas Frescas 454 g', price: '$79.00', priceOld: '$92.00', img: 'assets/fresas.webp' },
  { id: 's11', name: 'Moras Silvestres 250 g', price: '$65.00', priceOld: '$78.00', img: 'assets/mora.webp' },
  { id: 's12', name: 'Blueberries Orgánicos 125 g', price: '$72.00', priceOld: '$85.00', img: 'assets/blueberry.webp' },
  { id: 's13', name: 'Durazno Fresco Importado', price: '$38.00', priceOld: '$46.00', img: 'assets/durazno.webp' },
  { id: 's14', name: 'Aguacate Supremo Hass', price: '$93.00', priceOld: '$108.00', img: 'assets/aguacate.webp' },
  { id: 's15', name: 'Coco Fresco Entero', price: '$30.00', priceOld: '$38.00', img: 'assets/301841_01.webp' },
  { id: 's16', name: 'Uva Roja Suprema sin Semilla', price: '$135.00', priceOld: '$158.00', img: 'assets/uva-roja.webp' },
  { id: 's17', name: 'Pitahaya Rosa Fresca', price: '$38.00', priceOld: '$46.00', img: 'assets/427906_01.webp' },
];

// Productos que también participan en "Llévate producto Gratis": se ofrecen como sustituto
// cuando el producto original combina esa promo con "Quedan pocos", para no perderla.
const PROMO_SUBSTITUTES = [
  { id: 'g1', name: 'Papaya Maradol Chica', price: '$35.00', priceOld: '$42.00', img: 'assets/301918_01.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g2', name: 'Mango Ataulfo Premium', price: '$32.90', priceOld: '$39.90', img: 'assets/mango.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g3', name: 'Pitahaya Rosa Fresca', price: '$38.00', priceOld: '$46.00', img: 'assets/427906_01.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g4', name: 'Aguacate Supremo', price: '$93.00', priceOld: '$108.00', img: 'assets/aguacate.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g5', name: 'Fresas Frescas 454 g', price: '$79.00', priceOld: '$92.00', img: 'assets/fresas.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g6', name: 'Naranja Valencia Orgánica', price: '$37.00', priceOld: '$43.00', img: 'assets/naranja.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g7', name: 'Uva Roja Suprema sin Semilla', price: '$135.00', priceOld: '$158.00', img: 'assets/uva-roja.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g8', name: 'Manzana Red Delicious Importada', price: '$44.95', priceOld: '$54.95', img: 'assets/product-manzana-red.png', badgePink: 'Llévate producto Gratis' },
  { id: 'g9', name: 'Manzana Verde Granny Smith', price: '$37.50', priceOld: '$45.50', img: 'assets/product-manzana-verde.png', badgePink: 'Llévate producto Gratis' },
  { id: 'g10', name: 'Piña Miel Seleccionada', price: '$35.00', priceOld: '$42.00', img: 'assets/512260_01.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g11', name: 'Blueberries Orgánicos 125 g', price: '$72.00', priceOld: '$85.00', img: 'assets/blueberry.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g12', name: 'Moras Silvestres 250 g', price: '$65.00', priceOld: '$78.00', img: 'assets/mora.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g13', name: 'Frambuesas Frescas 125 g', price: '$68.00', priceOld: '$80.00', img: 'assets/frambuesa.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g14', name: 'Limón Persa Premium', price: '$28.00', priceOld: '$34.00', img: 'assets/Limon.webp', badgePink: 'Llévate producto Gratis' },
  { id: 'g15', name: 'Toronja Blanca Dulce', price: '$45.00', priceOld: '$52.00', img: 'assets/toronja.webp', badgePink: 'Llévate producto Gratis' },
];

// Cualquier tipo de producto puede elegirse como sustituto, no solo productos similares:
// la búsqueda es general a toda la tienda, no solo a frutas y verduras.
const OTHER_PRODUCTS = [
  ...
  { id: 'o8', name: 'Leche Deslactosada Light 1 L', price: '$24.50', priceOld: '$27.00', img: 'assets/leche.webp' },
  { id: 'o9', name: 'Café H-E-B French Roast Molido 400 g', price: '$89.00', priceOld: '$99.00', img: 'assets/cafe.webp' },
  { id: 'o10', name: 'Detergente Ariel Líquido Color 5 L', price: '$115.00', priceOld: '$135.00', img: 'assets/ariel.webp' },
  { id: 'o11', name: 'Agua Ciel Purificada 5 L', price: '$14.00', priceOld: '$17.00', img: 'assets/agua-ciel.webp' },
  { id: 'o12', name: 'Huevo Blanco Jumbo 18 pzas', price: '$68.00', priceOld: '$78.00', img: 'assets/huevo.webp' },
  { id: 'o13', name: 'Pan Blanco Bimbo 620 g', price: '$42.00', priceOld: '$48.00', img: 'assets/pan-bimbo.webp' },
  { id: 'o14', name: 'HCF Yogurt Sólido Natural 944 g', price: '$40.00', priceOld: '$46.00', img: 'assets/yogurt.webp' },
  { id: 'o15', name: 'la Villita Queso Oaxaca 400 g', price: '$86.00', priceOld: '$99.00', img: 'assets/queso-oaxaca.webp' },
  { id: 'o16', name: 'Cereal Kelloggs Zucaritas Original 600 g', price: '$100.00', priceOld: '$115.00', img: 'assets/cereal-zucaritas.webp' },
  { id: 'o17', name: 'Pasta Barilla Spaghetti No.5 200 g', price: '$11.00', priceOld: '$13.00', img: 'assets/pasta-barilla.webp' },
  { id: 'o18', name: 'Tuny Atún en Agua 130 g', price: '$20.50', priceOld: '$26.00', img: 'assets/atun-tuny.webp' },
  { id: 'o19', name: 'Refresco Coca-Cola Original 2.5 L', price: '$56.00', priceOld: '$64.00', img: 'assets/coca-cola.webp' },
  { id: 'o20', name: 'Sabritas Papas Clásicas Original 240 g', price: '$90.00', priceOld: '$104.00', img: 'assets/sabritas.webp' },
  { id: 'o21', name: 'Papel Higiénico Pétalo Ultra Jumbo 16 Rollos', price: '$89.00', priceOld: '$102.00', img: 'assets/papel-petalo.webp' },
  { id: 'o22', name: 'Head & Shoulders Shampoo Control Caspa Anti-Comezón 650 ml', price: '$109.00', priceOld: '$152.00', img: 'assets/shampoo-hs.webp' },
  { id: 'o23', name: 'HEB Pechuga sin Hueso de Pollo Fresca Familiar 1 kg', price: '$205.00', priceOld: '$235.00', img: 'assets/pechuga-pollo.webp' },
  { id: 'o24', name: 'Verde Valle Arroz Súper Extra 900 g', price: '$32.50', priceOld: '$37.00', img: 'assets/arroz-verde-valle.webp' },
  { id: 'o25', name: 'la Costeña Frijoles Enteros Negros 560 g', price: '$15.90', priceOld: '$18.50', img: 'assets/frijol-costena.webp' },
  { id: 'o26', name: 'Aceite 123 Vegetal Comestible 1 L', price: '$42.50', priceOld: '$49.00', img: 'assets/aceite-123.webp' },
  { id: 'o27', name: 'Oreo Original Vainilla 252 g', price: '$39.90', priceOld: '$46.00', img: 'assets/oreo.webp' },
  { id: 'o28', name: 'Del Valle Néctar de Durazno 1 L', price: '$30.50', priceOld: '$35.00', img: 'assets/nectar-durazno.webp' },
];

const ALL_PRODUCTS = SIMILAR_PRODUCTS.concat(OTHER_PRODUCTS).concat(PROMO_SUBSTITUTES);
...
function armSubstituteModal(productId) {
  // NO abrir modal automáticamente desde PLP
  // El modal solo se abre desde carrito/PDP cuando el usuario hace clic en "Con sustituto"
  // En PLP, los productos "Quedan pocos" se agregan normalmente al carrito
  clearTimeout(substituteDebounceTimers[productId]);
  // Modal deshabilitado en PLP - se abre solo desde carrito/PDP
}
...
function refreshProductUI(productId) {
  ...
  if (typeof pdpProductId !== 'undefined' && productId === pdpProductId) {
    renderPdpNotice();
    renderPdpFooterCta();
  }
...
function openSubstituteModal(productId) {
  ...
  closeSearchScreen();
  renderOriginSummary(productId);
  renderPromoCarousel(productId);
  updateSimilarTitle(productId);
  renderCarousel();
  renderSelectionSummary();
  updateSaveButton();
  // Note: initCarouselNav disabled due to browser freeze issue - needs investigation
  // initCarouselNav();
...
function selectChoice(choice) {
  ...
  renderCarousel();
  renderPromoCarousel(currentProductId);
  renderSearchGrid();
  renderSelectionSummary();
  updateSaveButton();
}
...
// Tarjeta de producto que también aplica "Llévate producto Gratis" (misma estructura que
// miniCardHtml, con el badge rosa entre la imagen y el precio).
function promoCardHtml(product) {
  ...
  return `
    <div class="plp-mini-card">
      ...
      <button type="button" class="plp-mini-info" onclick="selectChoice({type:'product', id:'${product.id}'})">
        <span class="plp-badge plp-badge-pink plp-mini-promo-tag">Llévate producto Gratis</span>
        <span class="plp-mini-old">${product.priceOld}</span>
        <span class="plp-mini-new">${product.price}</span>
        <span class="plp-mini-name">${product.name}</span>
      </button>
...
// Muestra carrusel de productos con promoción "Llévate producto Gratis"
// Siempre aparece para ofrecer sustitutos que mantengan la promoción
function renderPromoCarousel(productId) {
  const panel = document.getElementById('subPromoPanel');
  if (!panel) return;
  const product = PRODUCTS[productId];
  // Solo mostrar si el producto tiene la promoción "Llévate producto Gratis"
  const show = !!(product && product.badgePink === 'Llévate producto Gratis');
  panel.hidden = !show;
  if (show) {
    // Filtrar solo el producto exacto del modal, no por primera palabra
    const productName = product.name.toLowerCase();
    let filteredPromos = PROMO_SUBSTITUTES.filter(p => p.name.toLowerCase() !== productName);

    // Filtrar productos que ya están visibles en el PLP actual (comparar por nombre completo)
    if (window.visiblePlpProductIds && window.visiblePlpProductIds.size > 0) {
      filteredPromos = filteredPromos.filter(p => {
        const promoName = p.name.toLowerCase();
        for (const plpId of window.visiblePlpProductIds) {
          const plpProduct = PRODUCTS[plpId];
          if (plpProduct && plpProduct.name.toLowerCase() === promoName) {
            return false;
          }
        }
        return true;
    ...
    document.getElementById('subPromoCarousel').innerHTML = filteredPromos.slice(0, 6).map(promoCardHtml).join('');
    initPromoCarouselNav();
  }
}

function initPromoCarouselNav() {
  const carousel = document.getElementById('subPromoCarousel');
  const prevBtn = document.getElementById('subPromoCarouselPrev');
  const nextBtn = document.getElementById('subPromoCarouselNext');
...
// Cambiar el título del carrusel de opciones según si hay promociones o no
function updateSimilarTitle(productId) {
  const title = document.querySelector('.plp-similar-title');
  if (!title) return;
  const product = PRODUCTS[productId];
  const hasPromo = !!(product && product.badgePink === 'Llévate producto Gratis' && product.badgeGray === 'Quedan pocos');
  title.textContent = hasPromo ? 'O elige entre más opciones' : 'Elige un producto o una opción';
}
...
function renderCarousel() {
  // Obtener nombres de productos en subPromoCarousel (si está visible)
  const promoPanel = document.getElementById('subPromoPanel');
  const promoCarousel = document.getElementById('subPromoCarousel');
  const promoProductNames = new Set();

  if (!promoPanel.hidden && promoCarousel?.children.length > 0) {
    Array.from(promoCarousel.children).forEach(el => {
      const name = el.querySelector('.plp-mini-name')?.textContent?.trim().toLowerCase();
      if (name) promoProductNames.add(name);
    });
  }

  // Tomar productos patrocinados y similares (todos para garantizar suficientes después de filtrar)
  let sponsoredProducts = PROMO_SUBSTITUTES.slice(); // Todos disponibles
  let similarProducts = SIMILAR_PRODUCTS.slice(); // Todos disponibles

  // Filtrar PROMO_SUBSTITUTES que ya están en el PLP visible (para no duplicar con promoción)
  let filteredSponsored = sponsoredProducts;
  let filteredSimilar = similarProducts; // NO filtrar similares - siempre deben estar disponibles

  if (window.visiblePlpProductIds && window.visiblePlpProductIds.size > 0) {
    filteredSponsored = filteredSponsored.filter(p => {
      const productName = p.name.toLowerCase();
      for (const plpId of window.visiblePlpProductIds) {
        const plpProduct = PRODUCTS[plpId];
        if (plpProduct && plpProduct.name.toLowerCase() === productName) {
          return false;
        }
      }
      return true;
  ...
  // Garantizar exactamente 2 patrocinados + 3 similares
  const finalSponsored = filteredSponsored.slice(0, 2);
  const finalSimilar = filteredSimilar.slice(0, 3);
  const allProducts = [...finalSponsored, ...finalSimilar];

  // Los primeros 2 productos llevan el badge "Patrocinado"
  const productTiles = allProducts.map((p, i) => miniCardHtml(p, i < 2)).join('');
  const optionTiles = ['search', 'contact', 'none'].map(optionTileHtml).join('');
...
// Miniatura del producto original que se busca sustituir, fija arriba del modal.
function renderOriginSummary(productId) {
  const box = document.getElementById('subOriginSummary');
  if (!box) return;
  const product = PRODUCTS[productId];
  if (!product) { box.hidden = true; return; }
  const qty = plpQty[productId] || 0;
  const total = parsePrice(product.price) * qty;
  box.hidden = false;
  const badgeHtml = product.badgePink ? `<span class="plp-badge plp-badge-sm plp-badge-pink">${product.badgePink}</span>` : '';
  box.innerHTML = `
...
function renderSelectionSummary() {
  ...
  if (!box) return;
  const label = document.getElementById('subSelectionLabel');
  const setVisible = visible => {
    box.hidden = !visible;
    if (label) label.hidden = !visible;
  };
  // "No reemplazar" elimina el producto del pedido: no aplica el aviso de cobro por
  // el artículo sustituto que se reciba, porque no se recibe ninguno.
  const footerNote = document.getElementById('subFooterNote');
  if (footerNote) footerNote.hidden = !!(tempSelection && tempSelection.type === 'none');
  if (!tempSelection) {
    setVisible(false);
    box.innerHTML = '';
    return;
...
function renderSearchGrid() {
  ...
  let results = ALL_PRODUCTS.filter(p => p.name.toLowerCase().includes(query));

  // Filtrar productos que ya están visibles en el PLP actual
  if (window.visiblePlpProductIds && window.visiblePlpProductIds.size > 0) {
    results = results.filter(p => {
      const searchFirstWord = p.name.split(' ')[0].toLowerCase();
      for (const plpId of window.visiblePlpProductIds) {
        const plpProduct = PRODUCTS[plpId];
        if (plpProduct && plpProduct.name.split(' ')[0].toLowerCase() === searchFirstWord) {
          return false;
        }
      }
      return true;
...
function saveSelection() {
  ...
  // Si es un producto sustituto, guardar también su badgePink (promoción)
  if (type === 'product') {
    const substituteProduct = PRODUCTS[tempSelection.id] ||
                             PROMO_SUBSTITUTES.find(p => p.id === tempSelection.id) ||
                             SIMILAR_PRODUCTS.find(p => p.id === tempSelection.id);
    if (substituteProduct) {
      tempSelection.badgePink = substituteProduct.badgePink;
    }
  }
...
function renderPlpGrid() {
  ...
  let pageProducts = PLP_CATALOG.slice(start, start + PLP_PAGE_SIZE);

  // Deduplicar productos por nombre completo - evitar repeticiones exactas en la misma página
  ...
  // Guardar IDs de productos DEDUPLICADOS para filtrar en sustitutos
  window.visiblePlpProductIds = new Set(deduped.map(p => p.id));

  grid.innerHTML = deduped.map(plpCardHtml).join('');
  renderPlpPagination();
  initSubstituteUI();
}
...
/* initCarouselNav removed - carousel navigation buttons should not be initialized for the "Elige un producto o una opción" section */
